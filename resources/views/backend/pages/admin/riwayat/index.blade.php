                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="actions clearfix d-flex justify-content-end m-2">
                                <a class="btn btn-success m-1" href="{{ route('admin.riwayat.export') }}" role="menuitem">
                                            ...
                                            <td>
                                                <ul class="list-inline font-size-20 contact-links mb-0">
                                                    <li class="list-inline-item px-2">
                                                        <a href="{{ route('admin.riwayat.show', $transaksi->id) }}" class="btn btn-primary btn-sm text-white" title="Detail">
