...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.apotek.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Enter Apotek Name" value="{{ old('name') }}" required>
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-lg-8">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="address" id="address" class="form-control" rows="10" placeholder="Enter address apotek">{{ old('address') }}</textarea>
