                                    ...
                                    <section id="vertical-example-p-0" role="tabpanel" aria-labelledby="vertical-example-h-0" class="body current" aria-hidden="false">
                                            <div class="row">
                                                <div class="mt-3 mb-3">
                                                    ...
                                                    <input type="file" class="form-control form-control-xs" name="img_profile" id="img_profile" value="{{ old('img_profile') }}">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="name" id="name" placeholder="Enter Your Fullname" value="{{ old('name') }}" required>
                                                        @if ($errors->has('name'))
                                                            <div class="text-danger">
                                                                {{ $errors->first('name') }}
                                                            </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" class="form-control" name="email" id="email" placeholder="Enter Your E-mail" value="{{ old('email') }}" required>
                                                        @if ($errors->has('email'))
                                                            <div class="text-danger">
                                                                {{ $errors->first('email') }}
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="phone" id="phone" placeholder="Enter Your Phone" value="{{ old('phone') }}" required>
                                                        @if ($errors->has('phone'))
                                                            <div class="text-danger">
                                                                {{ $errors->first('phone') }}
                                                            </div>
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <label for="role">Role</label>
                                                        <select class="form-select" name="role" id="role">
                                                            ...
                                                            <option value="2" {{ old('role') == 2 ? 'selected' : '' }}>Apoteker</option>
                                                            <option value="3" {{ old('role') == 3 ? 'selected' : '' }}>Kurir</option>
                                                            <option value="4" {{ old('role') == 4 ? 'selected' : '' }}>Customer</option>
                                                        </select>
                                                        @if ($errors->has('role'))
                                                            <div class="text-danger">
                                                                {{ $errors->first('role') }}
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="apotek_id" id="apotek_id">
                                                            ...
                                                            @foreach ($apoteks as $apotek)
                                                                <option value="{{ $apotek->id }}" {{ old('apotek_id') == $apotek->id ? 'selected' : '' }}>{{ $apotek->name }}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="address" id="address" class="form-control" rows="5" placeholder="Enter Your Address">{{ old('address') }}</textarea>
                                ...
                                <div class="actions clearfix">
                                    <ul role="menu" aria-label="Pagination">
                                        <li aria-hidden="false" aria-disabled="false">
                                            <a class="btn btn-info" href="{{ route('admin.user') }}" role="menuitem">
