                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="actions clearfix d-flex justify-content-end m-2">
                                <a class="btn btn-success m-1" href="{{ route('kurir.order.export') }}" role="menuitem">
                                            ...
                                            <td>
                                                <ul class="list-inline font-size-20 contact-links mb-0">
                                                    <li class="list-inline-item px-2">
                                                        <form action="{{ route('kurir.order.accept', $transaksi->id) }}" method="POST" style="display: inline-block;">
                                                            @csrf
                                                            @method('PUT')
                                                        ...
                                                        <a href="{{ route('kurir.order.show', $transaksi->id) }}" class="btn btn-info" title="Detail">
