                        ...
                        <div class="bg-primary bg-soft">
                            <div class="row">
                                ...
                                <div class="col-5 align-self-end">
                                    <img src="{{ URL::asset('backend/assets/images/profile-img.png') }}" alt="" class="img-fluid" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <img src="{{ URL::asset('backend/assets/images/users/avatar-1.jpg') }}" alt="" class="img-thumbnail rounded-circle" />
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <h5>
                                    <a href="javascript: void(0);" class="text-dark">Facebook - <span class="text-muted font-16">125 sales</span> </a>
                                </h5>
                            ...
                            <ul class="verti-timeline list-unstyled">
                                ...
                                <li class="event-list">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <div>Everyone realizes why a new common language would be desirable... <a href="javascript: void(0);">Read more</a></div>
                                        </div>
                                    </div>
                                </li>
