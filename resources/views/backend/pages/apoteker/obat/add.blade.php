                            ...
                            <div id="vertical-example" class="vertical-wizard wizard clearfix vertical" role="application">
                                ...
                                <div class="steps clearfix">
                                    <ul role="tablist">
                                        <div class="mt-3">
                                            ...
                                            <input type="file" class="form-control form-control-sm" name="img_obat" id="img_obat" value="{{ old('img_obat') }}">
                                ...
                                <div class="content clearfix">
                                    <section id="vertical-example-p-0" role="tabpanel" aria-labelledby="vertical-example-h-0" class="body current" aria-hidden="false">
                                            <div class="row">
                                            <input type="hidden" name="apotek_id" id="apotek_id" value="{{ Auth::user()->apotek_id }}" required>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="harga" id="harga" placeholder="Enter Price" value="{{ old('harga') }}" required>
                                                        @if ($errors->has('harga'))
                                                            <div class="text-danger">
                                                                {{ $errors->first('harga') }}
                                                            </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="diskon" id="diskon" placeholder="Enter Discount" value="{{ old('diskon') }}" required>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="status" id="tersedia" value="Tersedia" {{ old('status') === 'Tersedia' ? 'checked' : '' }} required>
                                                            <label class="form-check-label" for="tersedia">
                                                                Tersedia
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="status" id="habis" value="Habis" {{ old('status') === 'Habis' ? 'checked' : '' }} required>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="deskripsi" id="deskripsi" class="form-control" rows="5" placeholder="Enter Your Description">{{ old('deskripsi') }}</textarea>
