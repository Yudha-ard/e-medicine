                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="actions clearfix d-flex justify-content-end m-2">
                                <a class="btn btn-success m-1" href="{{ route('apoteker.riwayat.export') }}" role="menuitem">
                                            ...
                                            <td>
                                                <ul class="list-inline font-size-20 contact-links mb-0">
                                                    <li class="list-inline-item px-2">
                                                        <a href="{{ route('apoteker.riwayat.show', $transaksi->id) }}" class="btn btn-sm btn-primary text-white" title="Edit">
