                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="actions clearfix d-flex justify-content-end m-2">
                                <a class="btn btn-success m-1" href="{{ route('apoteker.order.export') }}" role="menuitem">
                                ...
                                <table class="table align-middle table-nowrap table-hover">
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <td>{!! substr($transaksi->apotek->name, 0, 50) . ' ...' !!}</td>
                                            ...
                                            <td>
                                                <ul class="list-inline font-size-20 contact-links mb-0">
                                                    <li class="list-inline-item px-2">
                                                        ...
                                                        <form action="{{ route('apoteker.order.accept', $transaksi->id) }}" method="POST" style="display: inline-block;">
                                                            @csrf
                                                            @method('PUT')
                                                        ...
                                                        <form action="{{ route('apoteker.order.cancel', $transaksi->id) }}" method="POST" style="display: inline-block;">
                                                            @csrf
                                                            @method('PUT')
                                                        ...
                                                        <form action="{{ route('apoteker.order.delete', $transaksi->id) }}" method="POST" style="display: inline-block;">
                                                            @csrf
                                                            @method('DELETE')
                                                        ...
                                                        @endif
                                                        <a href="{{ route('apoteker.order.show', $transaksi->id) }}" class="btn btn-sm btn-primary text-white" title="Detail">
